...
class TableList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tableHead: ["DATE", "USER", "VENDOR", "COMMENT", "STATUS"],
            tableData: [
                ["1/1/2023", "Frolian Ernest", "Tigo", "Yes", ""],
                ["1/1/2023", "Frolian Ernest", "voda", "yes", ""],
                ["1/1/2023", "Frolian Ernest", "TTCL", "yes", ""],
                ["1/1/2023", "Frolian Ernest", "Halotel", "no", ""],
            ],
        };
    }
